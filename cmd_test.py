...
class DroneControlSim:
    ...
    def run(self):
        ...
        model0 = keras.models.load_model('/home/zhoujin/learning/model/quadm2_75t2.h5') # quad5 m4 m6(softplus 64) m5(softplus 640)
        ...
        for self.pointer in range(self.drone_states.shape[0]-1):      
            ...
            output = modelf(input.reshape(-1,15))
